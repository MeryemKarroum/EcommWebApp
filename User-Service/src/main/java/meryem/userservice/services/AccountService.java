...
import meryem.userservice.repositories.RoleRepository;
import meryem.userservice.repositories.UserRepository;
...
public class AccountService {
    ...
    public void registerUser(UserRegister userRegister) {
        ...
        Role role = roleRepository.findById(userRegister.getRoleId())
                .orElseThrow(() -> new RuntimeException("Role not found"));
        if (role == null) {
            logger.error("Role {} not found", userRegister.getRoleId());
